...
def header():
    ...
    title = html.H1("Stated Choice for House Preferences", style = {"fontSize": "30px", "color":"white"})
    subtitle = html.H6("A study on consumer preferences for residential properties", style = {"fontSize": "20px", "color":"white"}, className = "lead")
...
def footer():
    return html.Div([
        ...
        html.Div([
            html.P([
                "Survey ID: ",
                html.Strong("stated_preference_example", style={"color": survey_color}),
                " | Generated with ",
